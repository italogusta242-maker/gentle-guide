-- Adicionando colunas de classificação para permitir o "Swipe to Swap" (Substituição Inteligente)
ALTER TABLE public.exercise_library 
ADD COLUMN IF NOT EXISTS equipment text,
ADD COLUMN IF NOT EXISTS movement_pattern text;

-- Atualizando alguns exercícios básicos para habilitar o MVP da troca
...
-- Adicionando um índice para buscar substitutos mais rápido
